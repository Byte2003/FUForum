...
import { PermissionUpdateRequest } from '../../../shared/models/permission-update-request.model';
...
export class PermissionsComponent implements OnInit, OnDestroy {
  ...
  public savePermission() {
    ...
    const permissionsUpdateRequest = new PermissionUpdateRequest(listPermissions);
  ...
  checkChanged(event : CheckboxChangeEvent, commandId: string, functionId: string, parentId: string) {
    const checked = event.checked.includes(functionId);
  ...
  selectAll(checked: CheckboxChangeEvent, uniqueCode: string) {
