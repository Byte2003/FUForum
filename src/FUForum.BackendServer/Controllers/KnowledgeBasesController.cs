...
namespace FUForum.BackendServer.Controllers
{
    public partial class KnowledgeBasesController : BaseController
    {
        ...
        {
            _logger.LogInformation("Begin Post KnowledgeBase API");
            ...
            else
            {
                ...
                return BadRequest(new ApiBadRequestResponse("Create KnowledgeBase failed"));
            }
        }
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            if (knowledgeBase == null)
                return NotFound(new ApiNotFoundResponse($"Cannot found KnowledgeBase with id: {id}"));
        ...
        public async Task<IActionResult> PutKnowledgeBase(int id, [FromBody] KnowledgeBaseCreateRequest request)
        {
            var knowledgeBase = await _context.KnowledgeBases.FindAsync(id);
            if (knowledgeBase == null)
                return NotFound(new ApiNotFoundResponse("Cannot found KnowledgeBase"));
            ...
            return BadRequest(new ApiBadRequestResponse("Update KnowledgeBase failed"));
        }
